...
import Practica_Adicional_5.GenericException;
...
public class AminConexion {
	...
	public static Connection obtenerConexion() throws GenericException {
		...
		try {
			...
			throw new GenericException("No se pudo conectar a: " + url, sqe);
			
		}catch(ClassNotFoundException cnfe) {
			throw new GenericException("No se encontro el driver:" + driverName,cnfe);
		}
	}
